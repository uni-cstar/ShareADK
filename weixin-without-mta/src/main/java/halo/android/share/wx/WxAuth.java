...
public class WxAuth {
    ...
    /**
     * 获取微信AccessToken的url
     * api请求 Get方式 返回结果参考{@link halo.android.share.wx.model.WxAccessToken}
     * 请求是否成功 {@link halo.android.share.wx.model.WxAccessToken#isSuccess()}
     *
    ...
    /**
     * 获取微信用户信息
     * api请求 Get方式 返回结果参考{@link halo.android.share.wx.model.WxUserInfo}
     * 请求是否成功 {@link halo.android.share.wx.model.WxUserInfo#isSuccess()}
     *
     * @param accessToken 调用凭证
     * @param openid      普通用户的标识，对当前开发者帐号唯一 {@link halo.android.share.wx.model.WxUserInfo}
     * @return
     */
